<h2 class="title">Effectuer une recherche par auteur·ice</h2>
        ...
        if (!empty($viewVars['fetchedResults'])){
            ...
            <div class="card text-center border-info" style="width: 20rem;">
                <div class="card-body">
                    ...
                    <p class="card-text"><?= $result->getEmail(); ?></p>
                </div>
                <div class="card-footer">
                    <small class="text-muted"><a href='<?= $base_uri;?>/authors/<?= $result->getId(); ?>' class="btn btn-info">Accéder au profil de l'auteur·ice</a></small>
                </div>
            </div>
